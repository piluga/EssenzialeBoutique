...
window.chiudiModaleAvviso = function () {
    ...
    let isProdottoMancante = testoAvviso.includes("FORMATO NON DISPONIBILE") || testoAvviso.includes("ESAURIT") || testoAvviso.includes("GIACENZA");
...
// ==========================================
// 🎨 FIX 3 e 4: EFFETTI HOVER E FOCUS SUI CAMPI CASSA
// ==========================================
setTimeout(() => {
    ...
    campiCassa.forEach(id => {
        ...
        if (campo) {
            campo.addEventListener('mouseenter', function () {
                // Applica il verde chiaro al passaggio del mouse
                this.style.backgroundColor = '#47f547';

                // Posiziona automaticamente il cursore per il voucher
            ...
            campo.addEventListener('mouseleave', function () {
                // Svuota l'inline style, forzando il browser a tornare al colore di default del tema
